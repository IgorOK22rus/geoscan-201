...
Извлеките детали пусковой установки из транспорт.
...
.. figure:: _static/_images/ark1.png
   ...
   Соберите стандартные части пусковой установки и установите её на ровной поверхности так, чтобы запуск БВС происходил против ветра.
